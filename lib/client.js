...
function ProjectDialog({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-studio-dialog-backdrop", onMouseDown: (event) => {
    ...
    project === void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-studio-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "studio-project-workspace", children: kind === "attached" ? "\u9009\u62E9\u5DF2\u6DFB\u52A0\u7684 DSH \u5DE5\u4F5C\u533A" : "\u9009\u62E9\u65B0\u9879\u76EE\u7684\u7236\u5DE5\u4F5C\u533A" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { id: "studio-project-workspace", value: workspaceId, onChange: (event) => {
        ...
        workspaces.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: item.id, children: [
          item.title,
          " \u2014 ",
          item.path
        ] }, item.id))
    ...
    project !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-studio-project-binding", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u672C\u5730\u9879\u76EE" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: project.path })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-studio-dialog-actions", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dsh-studio-button primary", type: "button", disabled: saving || name.trim() === "" || workspaceId === "", onClick: () => {
        void save();
...
function StudioOverlay() {
  ...
  const [chatMinimized, setChatMinimized] = (0, import_react.useState)(false);
  const [chatPosition, setChatPosition] = (0, import_react.useState)(null);
  (0, import_react.useLayoutEffect)(() => {
  ...
  const toolbarStyle = chatPosition === null ? void 0 : { left: chatPosition.x, top: chatPosition.y, right: "auto" };
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "dsh-studio-overlay", style: { left: sidebarRight }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "dsh-studio-topbar", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "path", children: project.path })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `dsh-studio-layouts${chatMinimized ? " chat-minimized" : ""}`, "aria-label": "\u9879\u76EE\u5E03\u5C40", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `dsh-studio-stage${chatMinimized ? " chat-minimized" : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SplitSurface, { project, onMode: (mode, prompt) => {
        void handleMode(mode, prompt);
      } }) })
    ] }),
    !chatMinimized ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-studio-chat-toolbar", style: toolbarStyle, onPointerDown: dragChat, children: [
      ...
      chatPosition !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", "aria-label": "\u505C\u9760\u53F3\u4FA7", title: "\u505C\u9760\u53F3\u4FA7", onClick: () => {
        setChatPosition(null);
      }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconPanelLeftOutline16, { size: 14 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", "aria-label": "\u6700\u5C0F\u5316 AI", title: "\u6700\u5C0F\u5316", onClick: () => {
        setChatMinimized(true);
      }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconChevronDownOutline14, {}) })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "dsh-studio-chat-chip", type: "button", onClick: () => {
      setChatMinimized(false);
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconSparkle16, { size: 15 }),
      "AI \u534F\u4F5C"
    ] })
  ] });
}
var inject = ["slots", "theme", "sessions", "conversation", "workspaces"];
function apply(ctx) {
