...
function TerminalPanel({ project, onClose }) {
  ...
  const [status, setStatus] = (0, import_react3.useState)("running");
  const [output, setOutput] = (0, import_react3.useState)("");
  const [input, setInput] = (0, import_react3.useState)("");
  const [busy, setBusy] = (0, import_react3.useState)(false);
  const [error, setError] = (0, import_react3.useState)("");
  const offset = (0, import_react3.useRef)(0);
  const outputRoot = (0, import_react3.useRef)(null);
  (0, import_react3.useEffect)(() => {
    let cancelled = false;
    let timer;
    setSessionId(null);
    ...
    setError("");
    offset.current = 0;
    const append = (snapshot2, replace = false) => {
      offset.current = snapshot2.offset;
      setSessionId(snapshot2.sessionId);
      setShell(snapshot2.shell);
      setStatus(snapshot2.status);
      setOutput((previous) => replace ? snapshot2.output : previous + snapshot2.output);
    };
    const poll = async (id) => {
      let running = true;
      try {
      ...
      if (!cancelled && running) timer = window.setTimeout(() => {
        void poll(id);
      }, 350);
    };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("aside", { className: "dsh-studio-ai-sidebar dsh-studio-terminal-sidebar", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh-studio-ai-sidebar-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh-studio-terminal-shell", children: shell === "powershell" ? "PowerShell" : "macOS Shell" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: outputRoot, className: "dsh-studio-terminal-body", children: output === "" && error === "" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh-studio-terminal-empty", children: [
      "\u7EC8\u7AEF\u5DF2\u8FDE\u63A5\u5230\u5F53\u524D\u9879\u76EE",
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("br", {}),
      "\u8F93\u5165\u547D\u4EE4\u5F00\u59CB\u5DE5\u4F5C"
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("pre", { className: "dsh-studio-terminal-output", children: [
      output,
      error !== "" ? `
${error}` : ""
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("form", { className: "dsh-studio-terminal-form", onSubmit: (event) => {
      void submit(event);
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh-studio-terminal-prompt", children: "\u276F" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { className: "dsh-studio-terminal-input", value: input, onChange: (event) => {
        setInput(event.target.value);
      }, placeholder: status === "running" ? "\u8F93\u5165\u547D\u4EE4\u2026" : "\u7EC8\u7AEF\u5DF2\u9000\u51FA", disabled: sessionId === null || status !== "running", autoComplete: "off", spellCheck: false }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "dsh-studio-terminal-submit", type: "submit", "aria-label": "\u8FD0\u884C\u547D\u4EE4", disabled: sessionId === null || input.trim() === "" || busy || status !== "running", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives.IconChevronRightOutline14, { size: 15 }) })
    ] })
  ] });
}
